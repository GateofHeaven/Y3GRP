...
MagicZoom.prototype.initZoom = function() {
    ...
    this.bigImageCont.style.left = this.smallImage.width + 0 + 'px';
    this.bigImageCont.style.top = '-1px';
    switch (this.settings['position']) {
    case 'left':
        this.bigImageCont.style.left = '-' + (0 + parseInt(this.bigImageCont.style.width)) + 'px';
        break;
    case 'bottom':
        this.bigImageCont.style.top = this.smallImage.height + 0 + 'px';
        this.bigImageCont.style.left = '0px';
        break;
    case 'top':
        this.bigImageCont.style.top = '-' + (0 + parseInt(this.bigImageCont.style.height)) + 'px';
        this.bigImageCont.style.left = '0px';
        break;
    case 'custom':
        this.bigImageCont.style.left = '0px';
...
function MagicZoom_findZooms() {
    ...
    for (var i = 0; i < aels.length; i++) {
        if (/MagicZoom/.test(aels[i].className)) {
            ...
            matches = re.exec(aels[i].rel);
            bigCont.style.left = aels[i].firstChild.width + 0 + 'px';
